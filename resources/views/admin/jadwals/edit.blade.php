...
<div class="container py-4">
    ...
    <div class="mb-4">
        <h2 class="fw-bold m-0 text-dark">
            <i class="fas fa-edit text-warning me-2"></i>Edit Jadwal Tayang
        </h2>
        <small class="text-muted">Perbarui data film, lokasi studio, waktu penayangan, atau harga tiket</small>
    </div>

    <div class="card shadow border-0" style="border-radius: 12px; overflow: hidden;">
        <div class="card-header bg-warning py-3 border-0">
            <h5 class="mb-0 fw-bold text-dark"><i class="fas fa-calendar-alt me-2"></i>Formulir Perubahan Jadwal</h5>
        </div>
            ...
            <form action="{{ route('jadwals.update', $jadwal->id) }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="time" name="jam_tayang" value="{{ substr($jadwal->jam_tayang, 0, 5) }}" class="form-control" required>
                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" name="harga_tiket" value="{{ $jadwal->harga_tiket }}" class="form-control" placeholder="Contoh: 35000" required>
                        </div>
                    </div>
                </div>
